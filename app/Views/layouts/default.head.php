...
<html>
<head>
    <title><?php echo $this->title; ?> | Nemex</title>
	...
	<?php if (!empty(Config\Config::MARKDOWN_CSS)) { ?>

	<link rel="stylesheet" type="text/css" href="app/webroot/assets/css/<?php echo Config\Config::MARKDOWN_CSS; ?>-markdown.css">
	<?php } ?>
